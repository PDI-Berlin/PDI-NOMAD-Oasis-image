...
```sh
curl -L -o nomad-oasis.zip "https://github.com/PDI-Berlin/PDI-NOMAD-Oasis-image/raw/main/nomad-oasis.zip"
```
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/PDI-Berlin/PDI-NOMAD-Oasis-image/manifests/main": unauthorized`
